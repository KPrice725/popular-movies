...
public class ModelConstants {
    ...
    // Provides the base URL for the video list query to get trailers associated with a given movie
    public static final String TMDB_API_GET_VIDEOS_URL = TMDB_API_GET_MOVIE_URL;

    // Provides the base URL for the review list query to get reviews associated with a given movie
    public static final String TMDB_API_GET_REVIEWS_URL = TMDB_API_GET_MOVIE_URL;
